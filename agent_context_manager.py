...
class AgentContextManager:
    ...
    def __init__(self, orchestrator_root: Optional[str] = None):
        ...
        logger.info(
            f"AgentContextManager initialized",
            extra={"orchestrator_root": str(self.orchestrator_root), "working_dir": str(self.working_dir)},
        )
    ...
    def _find_orchestrator_root(self, provided_path: Optional[str] = None) -> Path:
        ...
        raise RuntimeError(
            "Cannot find Tmux-Orchestrator installation. " "Please set TMUX_ORCHESTRATOR_HOME environment variable."
        )
...
"""
    ...
    def inject_context_into_briefing(
        self, original_briefing: str, session_name: str, agent_name: str, workspace: Path
    ) -> str:
        """
