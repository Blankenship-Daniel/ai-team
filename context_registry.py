...
class ContextCheckpoint:
    ...
    @classmethod
    def create(cls, agent_id: str, session_name: str, window_index: int, 
               context_data: Dict[str, Any], parent_id: Optional[str] = None) -> 'ContextCheckpoint':
...
class ContextRegistry:
    ...
    def create_checkpoint(self, session_name: str, window_index: int, 
    ...
    def should_create_checkpoint(self, session_name: str, window_index: int, 
    ...
    def cleanup(self, session_name: str = None, keep_count: int = 100):
