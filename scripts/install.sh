...
create_backup() {
    ...
    while IFS= read -r -d '' file; do
        ai_files+=("$file")
    done < <(find "$INSTALL_DIR" -name "*ai-team*" -o -name "*ai-bridge*" -o -name "tmux_utils.py" -o -name "context_registry.py" -o -name "unified_context_manager.py" -o -name "logging_config.py" -o -name "security_validator.py" -o -name "interfaces.py" -o -name "ai-team" -print0 2>/dev/null || true)
