        ...
        try:
            ...
            try:
                ...
                metadata = {
                    ...
                    "system_info": {"platform": os.name, "cwd": os.getcwd(), "user": os.environ.get("USER", "unknown")},
        ...
        try:
            ...
            try:
                with tarfile.open(backup_file, "r:gz") as tar:
                    # Secure extraction - validate member paths
                    safe_members = []
                    ...
                    tar.extractall(temp_restore_dir, members=safe_members)  # nosec B202
