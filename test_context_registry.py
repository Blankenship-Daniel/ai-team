...
from context_registry import (
    ContextCheckpoint, ContextState, SQLiteContextStore, ContextRegistry
)
...
class TestContextCheckpoint:
    ...
    def test_checkpoint_deterministic_hash(self):
        ...
        checkpoint1 = ContextCheckpoint.create(
            agent_id='hash:0', session_name='hash', window_index=0,
            context_data=context_data
        )
        
        checkpoint2 = ContextCheckpoint.create(
            agent_id='hash:1', session_name='hash', window_index=1,
            context_data=context_data
        )
        ...
        checkpoint3 = ContextCheckpoint.create(
            agent_id='hash:2', session_name='hash', window_index=2,
            context_data=different_context
        )
