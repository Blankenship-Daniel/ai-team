...
from ai_team.core.unified_context_manager import UnifiedContextManager, AgentWorkspace
...
class TestAgentLifecycleIntegration:
    ...
    def test_agent_creation_with_context_registry(self, temp_dir):
        ...
        checkpoint_id = registry.create_checkpoint("integration-test", 0, initial_context)
